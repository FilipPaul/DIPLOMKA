...
#define MUX_D_9_Pin GPIO_PIN_0
#define MUX_D_9_GPIO_Port GPIOC
#define ADC_CH_3_Pin GPIO_PIN_3
#define ADC_CH_3_GPIO_Port GPIOA
#define MUX_D_6_Pin GPIO_PIN_6
#define MUX_D_6_GPIO_Port GPIOA
#define MUX_D_8_Pin GPIO_PIN_0
#define MUX_D_8_GPIO_Port GPIOB
#define MUX_D7_Pin GPIO_PIN_1
#define MUX_D7_GPIO_Port GPIOB
#define BOOT1_Pin GPIO_PIN_2
#define BOOT1_GPIO_Port GPIOB
#define MUX_D_10_Pin GPIO_PIN_11
#define MUX_D_10_GPIO_Port GPIOF
...
#define MUXes_6TO10_A2_Pin GPIO_PIN_1
#define MUXes_6TO10_A2_GPIO_Port GPIOG
#define GPIO_6TO10_A1_Pin GPIO_PIN_7
#define GPIO_6TO10_A1_GPIO_Port GPIOE
...
#define NMOS_SHIFT_6TO10_SER_Pin GPIO_PIN_15
#define NMOS_SHIFT_6TO10_SER_GPIO_Port GPIOB
...
#define NMOS_SHFT_1TO5_SRCLR_Pin GPIO_PIN_10
...
#define MUX_D_5_Pin GPIO_PIN_4
#define MUX_D_5_GPIO_Port GPIOG
#define MUX_D_4_Pin GPIO_PIN_5
#define MUX_D_4_GPIO_Port GPIOG
#define MUX_D_3_Pin GPIO_PIN_6
#define MUX_D_3_GPIO_Port GPIOG
#define MUX_D_2_Pin GPIO_PIN_7
#define MUX_D_2_GPIO_Port GPIOG
#define MUX_D_1_Pin GPIO_PIN_8
#define MUX_D_1_GPIO_Port GPIOG
#define MUXes_1to5__A0_Pin GPIO_PIN_6
#define MUXes_1to5__A0_GPIO_Port GPIOC
#define MUXes_1to5_nEN_Pin GPIO_PIN_7
#define MUXes_1to5_nEN_GPIO_Port GPIOC
#define MUXes_1to5__A1_Pin GPIO_PIN_8
#define MUXes_1to5__A1_GPIO_Port GPIOC
#define MUXes_1to5__A2_Pin GPIO_PIN_9
#define MUXes_1to5__A2_GPIO_Port GPIOC
...
#define NMOS_SHFT_1TO5_SRCLRD2_Pin GPIO_PIN_2
#define NMOS_SHFT_1TO5_SRCLRD2_GPIO_Port GPIOD
