...
\include{text/Koncept_funkcnosti_testeru}
\include{text/navrh_mericich_karet}
\include{text/navrh_ovladacich_karet}
\include{text/reseni2}
\include{text/pcaplikace}
\include{text/VysledkyMereni}
...
\chapter{Měřící karta}
\section{Měřící karta - schéma}
\begin{landscape}
\includepdf[pages = -,angle = 90]{pdf/schema_merici_karta}
\end{landscape}

\section{Měřící karta - PCB}
\begin{landscape}
\includepdf[pages = -,angle = 90]{pdf/Merici_karta_pcb}
\end{landscape}



\clearpage
\chapter{Ovládací karta}
\section{Ovládací karta - schéma}
\begin{landscape}
\includepdf[pages = -,angle = 90]{pdf/schema_ovl_karta}
\end{landscape}

\section{Ovládací karta - PCB}
\begin{landscape}
\includepdf[pages = -,angle = 90]{pdf/Ovl_karta_pcb}
\end{landscape}
